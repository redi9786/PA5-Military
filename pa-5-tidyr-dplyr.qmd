...
author: "Megan Redican and Efrain Ramirez"
format: html
...
military <- read_xlsx("gov_spending_per_capita.xlsx",  #reading in the data
                      sheet = "Share of Govt. spending",    #selecting the sheet within the dataset
                      skip  = 7,                            #skipping 7 rows
                      n_max = 191,                          #making 191 rows the max amount of data
                      na = c("xxx", ". ."))                  #replacing missing values as na
```
...
> It is just exluding the regions from the country column, so it only includes countries rather than regions.
